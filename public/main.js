...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(http, globals, router, fb, toastr) {
        this.http = http;
        this.globals = globals;
        this.router = router;
        this.fb = fb;
